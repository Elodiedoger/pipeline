...
def ct_to_atlas(trans_nl,trans_2, atlas_nii, ct_cut_brain_nii,
    ...
    ct_cut_brain_to_atlas_nii = os.path.join(output_dir, "cut_ct_to_atlas.nii.gz") 
    ...
    # Warp the ct
    cmd = ["applywarp", "-i", ct_cut_brain_nii, "-o", ct_cut_brain_to_atlas_nii,
...
if __name__ == "__main__":
    ...
    ct_cut_brain_nii = os.path.join(analysis_path, "results","ct_to_mri","sujet_005", "ct_cut_brain.nii.gz")
    trans_2 = os.path.join(analysis_path, "results","ct_to_mri","sujet_005", "trans_2.txt")
    trans_nl = os.path.join(analysis_path,"mri_to_atlas","sujet_005","t1_to_atlas_nl_field.nii.gz")
